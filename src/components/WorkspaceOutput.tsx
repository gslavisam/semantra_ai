              ...
              <div className="flex flex-wrap bg-slate-100 p-0.5 rounded-lg border border-slate-200 self-start sm:self-auto gap-1">
                <button
                  ...
                  className={`px-3 py-1 text-xs font-medium rounded-md transition-all flex items-center gap-1.5 ${
                    activeCodeTab === 'datacontract' ? 'bg-indigo-600 text-white font-bold shadow-sm' : 'text-indigo-700 hover:text-indigo-900 bg-indigo-50/80 border border-indigo-200 font-semibold'
                  }`}
